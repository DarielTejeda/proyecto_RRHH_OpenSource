                                        ...
                                        <div class="row contentbody">
                                            <div class="col-sm-6">
                                                <ul>
                                                    ...
                                                    <li><i class="fa fa-sun-"></i>Duración de la Vacante: <?php echo $result->DURATION_EMPLOYEMENT; ?></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-6">
                                                <ul>
                                          ...
                                          <a href="<?php echo web_root; ?>index.php?q=apply&job=<?php echo $result->JOBID;?>&view=personalinfo" class="btn btn-main btn-next-tab">Aplicar Ahora!</a>
                                    </div>
                                </div>
                            </div> 
                        </div>
