...
<head>
<meta charset="utf-8">
<title>RRHH / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. +1 (809) 736-4787</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">RRHH<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="<?php echo web_root; ?>index.php">Inicio</a></li> 
                        <li class="dropdown">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Buscar Por Trabajo <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">Trabajo Por Compañia</a></li>
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Categorías Desatacadas <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='company'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=company">Compañias</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Vacantes</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Nuestro Contacto Directo</h5>
          <address>
          <strong>Nuestra Compañia</strong><br>
          Blue Mall, Cerca De La Av. 27 de Febrero<br>
           Pin-64367 Santo Domingo RD.</address>
          <p>
            <i class="icon-phone"></i> +1 (809) 456-7896 / 125-4765 <br>
            <i class="icon-envelope-alt"></i> darielalejandrotejedajimenez@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Enlaces Directos</h5>
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php">Inicio</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=company">Compañias</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=hiring">Vacantes</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=About">Sobre Nosotros</a></li>
