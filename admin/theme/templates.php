...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-lg"><b>RRHH</b></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" role="navigation">
      <!-- Sidebar toggle button-->
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
        <span class="sr-only">Navegación de Alerta</span>
      </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo web_root ;?>admin/logout.php" class="btn btn-default btn-flat">Salir</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'applicants') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/applicants/">
            <i class="fa fa-users"></i> <span>Aplicantes</span> 
       ...
       <!--  <li class="treeview">
         ...
         <li class="<?php echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/user/">
            <i class="fa fa-user"></i> <span>Administrar Usuarios</span> </a>
        </li>
