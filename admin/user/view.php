...
<div class="panel-body inf-content">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1><strong>Perfil del Usuario</strong></h1><br>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder=
                            "Nombre de la cuenta" type="text" value="<?php echo $singleuser->FULLNAME; ?>">
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                            "Dirección de Email" type="text" value="<?php echo $singleuser->USERNAME; ?>">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          ...
                          <option value="Staff" <?php echo ($singleuser->ROLE=='Staff') ? 'selected="true"': '' ; ?>>Personal</option>  
                        </select> 
                      </div>
                    </div>
                  </div>
