                        ...
                        <div class="col-md-8">
                          <input name="deptid" type="hidden" value="">
                           <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder=
                              "Primer Nombre" type="text" value=""   autocomplete="off">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8">
                          ...
                          <input  class="form-control input-sm" id="MNAME" name="MNAME" placeholder=
                              "Segundo Nombre"     autocomplete="off">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS" placeholder=
                            "Dirección" type="text" value="" required   autocomplete="off"></textarea>
                      </div>
                    </div>
                  </div> 
                      ...
                      <div class="col-md-8">
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                                      "No. de Contacto" type="text" any value="" required   autocomplete="off">
                                </div>
                              </div>
                            </div> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder=
                                      "Posición" type="text" any value="" required   autocomplete="off">
                                </div>
                              </div>
                            </div>  
                        ...
                        <!--     <div class="form-group">
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "EMP_HIREDDATE">Fecha de Contratación:</label> 
                                <div class="col-md-8">
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   <input type="Email" class="form-control input-sm" id="EMP_EMAILADDRESS" name="EMP_EMAILADDRESS" placeholder="Dirección de Email"   autocomplete="false"/> 
                                </div>
                              </div>
                            </div>  
