                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8">
                          ...
                          <input  class="form-control input-sm" id="LNAME" name="LNAME" placeholder=
                              "Apellido"    onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                                      "No. de Contacto" type="text" any value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div> 
                        ...
                        <!--     <div class="form-group">
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "EMP_EMAILADDRESS">Dirección de Correo:</label> 
                                <div class="col-md-8">
                                   <input type="Email" class="form-control input-sm" id="EMP_EMAILADDRESS" name="EMP_EMAILADDRESS" placeholder="Dirección de Correo"   autocomplete="false"/> 
                                </div>
                              </div>
                            </div>  
