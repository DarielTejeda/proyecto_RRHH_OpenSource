...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Listas de Vacantes  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Añadir Nueva Vacante</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table" class="table table-striped table-bordered table-hover"  style="font-size:12px" cellspacing="0">
				  ...
				  <thead>
				  	<tr>
				  		...
				  		<th>Título de Ocupación</th> 
				  		<th>Número de Empleados Requeridos</th> 
				  		<th>Salarios</th> 
				  		<th>Duración del Empleo</th> 
				  		<th>Calificación/Experiencia Laboral</th> 
				  		<th>Descripción Del Empleo</th> 
				  		<th>Sexo Preferido</th> 
				  		<th>Sector de la Vacante</th> 
				  		<th>Estatus del Empleo</th> 
