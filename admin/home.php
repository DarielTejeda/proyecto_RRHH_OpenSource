        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="dist/img/user4-128x128.jpg" alt="" class="online">
                ...
                <p class="message">
                  ...
                  Me gustaría reunirme con vosotros para comentar las últimas novedades sobre la llegada del nuevo tema. Dicen que va a ser uno de los mejores temas del mercado.
                </p>
              ...
              <!-- chat item -->
              <div class="item">
                <img src="dist/img/user3-128x128.jpg" alt="" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="dist/img/user2-160x160.jpg" alt="" class="offline">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">Diseñar un nuevo tema</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="" name="">
                  <span class="text">Hacer los inventarios cotidianos</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="" name="">
                  <span class="text">Revisar tus mensajes y notificaciones</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="" name="">
                  <span class="text">Crear zonas recreativas</span>
            ...
            <div class="box-footer clearfix no-border">
              <button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar  Articulo</button>
            </div>
          </div>
          <!-- /.box -->
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Email Rapído</h3>
              <!-- tools box -->
            ...
            <div class="box-footer no-border">
              <div class="row">
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Envios por Correo</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                ...
                <div class="col-xs-4 text-center">
                  ...
                  <div class="knob-label">En el almacén</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
