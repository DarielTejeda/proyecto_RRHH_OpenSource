...
?> 
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
            ...
            <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Actualizar AutoNúmero</h1>
          </div>
          <!-- /.col-lg-12 -->
       </div> 
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <input  type="hidden" name="AUTOID" id="AUTOID" value="<?php  echo $singleauto->AUTOID; ?>">
                         <input class="form-control input-sm" id="AUTOSTART" name="AUTOSTART" placeholder=
                            "Comenzar" type="text" value="<?php  echo $singleauto->AUTOSTART; ?>">
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "AUTOEND">Terminar:</label>

                      <div class="col-md-8">
                         <input class="form-control input-sm" id="AUTOEND" name="AUTOEND" placeholder=
                            "Terminar" type="text" value="<?php  echo $singleauto->AUTOEND; ?>">
                      </div>
                    </div>
                  </div>
