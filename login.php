              ...
              <div class="modal-content">
                ...
                <!-- <form action="process.php?action=login" enctype="multipart/form-data" method="post"> -->
                  <div class="modal-body hold-transition login-page">
                    ...
                    <div class="login-box"> 
                        <div class="login-box-body" style="border: solid 1px #ddd;padding: 35px;min-height: 350px;"> 
                            ...
                            <div class="row">
                              <div class="col-xs-8">
                                <div class="checkbox icheck">
                                  <label>
                                    <input type="checkbox"> Recuérdame Con Esta Cuenta
                                  </label>
                                </div>
                              </div>
                              <!-- /.col -->
                          ...
                          <a href="#">Ólvide Mi Contraseña</a><br>
                          <a href="<?php echo web_root; ?>index.php?q=register" class="text-center">Registrarse Como Nuevo Miembro</a>
                  ...
                  <div class="modal-footer">
                    ...
                    name="btnlogin" id="btnlogin"  >Iniciar Sesión</button>
                  </div>
                <!-- </form> -->
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
