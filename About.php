									 ...
									 <div class="panel-heading">
										<h4 class="panel-title">
										  <a data-toggle="collapse" data-parent="#accordion-alt3" href="#collapseOne-alt3">
											<i class="fa fa-angle-right"></i> Elemento De Texto De Encabezado # 1
										  </a>
										</h4>
									 </div>
									 ...
									 <div class="panel-heading">
										<h4 class="panel-title">
										  <a data-toggle="collapse" data-parent="#accordion-alt3" href="#collapseTwo-alt3">
											<i class="fa fa-angle-right"></i> Elemento De Texto De Encabezado # 2
										  </a>
										</h4>
									 </div>
									 ...
									 <div class="panel-heading">
										<h4 class="panel-title">
										  <a data-toggle="collapse" data-parent="#accordion-alt3" href="#collapseThree-alt3">
											<i class="fa fa-angle-right"></i> Elemento De Texto De Encabezado # 3
										  </a>
										</h4>
									 </div>
									 ...
									 <div class="panel-heading">
										<h4 class="panel-title">
										  <a data-toggle="collapse" data-parent="#accordion-alt3" href="#collapseFour-alt3">
											<i class="fa fa-angle-right"></i> Elemento De Texto De Encabezado # 4
										  </a>
										</h4>
									 </div>
							...
							<div class="col-md-4">
								...
								<div class="progress pb-sm">
								  ...
								  <div class="progress-bar progress-bar-red" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
									 <span class="sr-only">40% Completado (Satisfactorio)</span>
								  </div>
								</div>
								<h6>Diseñador</h6>
								<div class="progress pb-sm">
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										...
										<!-- Name -->
										<h4>Johne Doe</h4>
										<span class="deg">Artista Creativo</span> 
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<!-- Team Member -->
									<div class="team-member">
										...
										<!-- Name -->
										<h4>Jennifer Acosta</h4>
										<span class="deg">Programadora</span> 
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<!-- Team Member -->
